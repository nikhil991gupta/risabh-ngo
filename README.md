# The Risabh-NGO NGO - ReactJS & SpringBoot Project

This project is a web application for The Risabh-NGO NGO. It's built using **ReactJS**, **Axios**, and **Bootstrap**.
...
- **SrpingBoot**: Backend repo: `https://github.com/bhaveshpatil07/The-Risabh-NGO-NGO-Server`.

## Getting Started

Clone the repository:
```bash
git clone https://github.com/bhaveshpatil07/The-Risabh-NGO-NGO-ReactJs
```
